    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-black relative px-6 py-10 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-base text-zinc-400">{t("welcome")}</p>
        </div>
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
              ...
              <div className="flex items-center justify-center gap-2 mt-4">
                <span className="text-sm text-zinc-400">{t("links.noAccount")}</span>
                <Link
                  to="/invite"
                  ...
                  aria-label={t("accessibility.createAccountButton")}
                >
